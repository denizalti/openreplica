...
class Node():
    ...
    def __init__(self, nodetype, port=options.port, bootstrap=options.bootstrap):
        ...
        logger("Ready!")
        self.groups = {NODE_ACCEPTOR:Group(self.me), NODE_REPLICA: Group(self.me), NODE_LEADER:Group(self.me), NODE_MEMBERSHIP:Group(self.me), NODE_NAMESERVER:Group(self.me)}
