...
setup(name='concoord',
      ...
      packages=['concoord', 'concoord.object', 'concoord.proxy',
                'concoord.threadingobject', 'concoord.openreplica',
                'concoord.test'],
      scripts=['scripts/concoord', 'scripts/bash_completion/concoord'],
      data_files=[('/etc/bash_completion.d', ['scripts/bash_completion/concoord']),
                  ('/usr/bin', ['scripts/concoord'])],
