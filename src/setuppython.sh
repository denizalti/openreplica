...
do
    echo "$var"
    scp -i openreplicakey -o StrictHostKeyChecking=no python2.7.tar.gz $SLICENAME@$var:
    ssh -i openreplicakey -o StrictHostKeyChecking=no $SLICENAME@$var tar xzf python2.7.tar.gz
