...
MSG_PREPARE, MSG_PREPARE_ADOPTED, MSG_PREPARE_PREEMPTED, MSG_PROPOSE, \
    ...
    MSG_GARBAGECOLLECT, MSG_STATUS = range(19)

# message fields
MSGID, MSGTYPE, MSGSRC, BALLOTNUMBER, COMMANDNUMBER, PROPOSAL, DECISIONS, \
REPLY, REPLYCODE, INRESPONSETO, SNAPSHOT, PVALUESET, LEADER, TOKEN, BATCH = range(15)
