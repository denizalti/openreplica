...
do
    ...
    ssh -i ../secret/openreplicaplkey -o StrictHostKeyChecking=no $SLICENAME@$var 'cd concoord-0.3.0/ && /home/cornell_openreplica/python2.7/bin/python2.7 setup.py install'
done